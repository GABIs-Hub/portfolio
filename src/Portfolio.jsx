...
const SKILLS = [
  ...
  { name: "Android SDK", level: 70, category: "Mobile" },
  { name: "iOS UIKit / SwiftUI", level: 12, category: "Mobile" },
  { name: "Java", level: 10, category: "Mobile" },
  { name: "Javascript React", level: 80, category: "Web" },
  { name: "TypeScript React", level: 75, category: "Web" },
  { name: "Vite", level: 88, category: "Web" },
  ...
  { name: "Framer Motion", level: 22, category: "Tools" },
];
          ...
          {NAV_LINKS.map((l) => (
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                color:
                  active === l.toLowerCase() ? "#10b981" : "#64748b",
                fontFamily: "'DM Sans', sans-serif",
                fontSize:
                  active === l.toLowerCase() ? "1.1rem" : "0.875rem",
...
function HeroSection() {
  const typed = useTypewriter(
    ["Flutter Developer", "React Native Dev", "Mobile-First Builder", "Web Developer", "New to Swift"],
    80,
    1900
  );
              ...
              <Reveal key={i} delay={i * 130}>
                {isMobile ? (
                  <div style={{ display: "flex", gap: "1rem", marginBottom: "2rem" }}>
                    ...
                    <Glass
                      accent={item.accent}
                      style={{ padding: "1.4rem", flex: 1, marginBottom: 0 }}
                    >
...
function ContactSection() {
  ...
  const submit = () => {
    ...
    emailjs
      .send("service_3eiehja", "template_cyjeja4", {
  ...
  const inp = (field) => ({
    ...
    style: {
      ...
      border: `1px solid ${
        focused === field ? "rgba(6,182,212,0.5)" : "rgba(255,255,255,0.08)"
      }`,
      color: "#e2e8f0",
      fontFamily: "'DM Sans', sans-serif",
      fontSize: "0.93rem",
                  ...
                  style={{
                    color:
                      hoveredSocial === s.label
                        ...
                        : "#475569",
                    fontSize:
                      hoveredSocial === s.label ? "1.8rem" : "1.4rem",
                    textDecoration: "none",
                    display: "flex",
                    alignItems: "center",
                    gap: "0.4rem",
